...
export default function HeaderLat() {
  ...
  return (
    <aside className={`h-screen bg-white border-r border-green-100 fixed top-0 left-0 z-40 transition-all duration-300 ${collapsed ? 'w-16' : 'w-56'}`}> 
      ...
      <nav className="mt-6 flex flex-col gap-2">
        <Link href="/dashboard/empresa" className="flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-green-50 transition-colors">
          <Home className="w-5 h-5" />
          <span className={`${collapsed ? 'hidden' : 'block'}`}>Inicio</span>
        </Link>
        <Link href="#" className="flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-green-50 transition-colors">
        ...
        <Link href="#" className="flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-green-50 transition-colors mt-8">

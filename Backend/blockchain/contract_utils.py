...
def sign_document(document_hash: str):
    ...
    signed_txn = web3.eth.account.sign_transaction(txn, private_key)
     # --- LÍNEAS DE DEPURACIÓN PARA signed_txn ---
    # Esto te ayudará a ver qué atributos tiene si el error persiste
    print(f"Tipo de signed_txn: {type(signed_txn)}")
    print(f"Atributos de signed_txn: {dir(signed_txn)}")
